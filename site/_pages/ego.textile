...
"View code on GitHub.":https://github.com/JakeCoxon/ego
This is the code to my personal website. Soon I will create an empty site for you to start from scratch
